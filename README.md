...
## サイトスキーマ
<img width="1407" alt="スクリーンショット 2020-07-26 15 23 01" src="https://user-images.githubusercontent.com/62681326/88472992-f9e52280-cf53-11ea-9fb4-aafd2087192f.png">
...
### インフラ
- AWS(VPC,EC2,RDS,S3,Route53,CloudWatch)
...
- 並び替え、絞り込み機能(投稿時間、いいね・共感・ブックマーク数、評価で並び替え、回答の状態で絞り込み、タグ検索後のキーワード絞り込み)
